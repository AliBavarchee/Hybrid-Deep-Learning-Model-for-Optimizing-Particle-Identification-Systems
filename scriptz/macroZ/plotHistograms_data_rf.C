...
void plotHistograms_data_rf()
{
    // Open the root file
    TFile* file = TFile::Open("Dst_b29_bucket29_merged_sWeights.root");
    ...
    canvas->SaveAs("ANEW_data_histograms_likelihood_ratios_Deep_rf.root");
