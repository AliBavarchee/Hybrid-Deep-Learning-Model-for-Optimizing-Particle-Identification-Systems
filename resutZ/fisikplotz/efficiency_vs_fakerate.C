...
void efficiency_vs_fakerate() {
    ...
    for (Long64_t iEntry = 0; iEntry < nEntries; iEntry++) {
        ...
        Double_t efficiency = (Ture_K_SVD + Ture_K_CDC) /
            (Ture_K_SVD + Ture_K_CDC + False_pi_SVD + False_pi_CDC);

        Double_t fakeRate = (False_K_SVD + False_K_CDC) /
            (False_K_SVD + False_K_CDC + True_pi_SVD + True_pi_CDC);
    ...
    canvas->SaveAs("EfficiencyVsFakeRate002.root");
