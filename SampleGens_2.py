...
output_file = ROOT.TFile("Dstar_D0_pi_K_0001.root", "RECREATE")
...
for event in pythia(events=100):  # Simulate 100 events
    ...
    for particle in event:
        ...
        # Check if the particle is a Kaon from D0 decay
        if particle.id() == 321 and particle.pT() > 0.5 and particle.isFinal():
            Kaons.append(particle)
